...
const h1Y = layerPositions(64, 900);
const h2Y = layerPositions(64, 900);
const outY = layerPositions(10, 900, 40); // margine più grande, sono solo 10
...
const h1Circles = h1Y.map(y => createCircle(H1_X, y, 2.5, "#333"));
const h2Circles = h2Y.map(y => createCircle(H2_X, y, 2.5, "#333"));
...
console.log("three.js caricato, pronto a disegnare la rete neurale", THREE.REVISION);